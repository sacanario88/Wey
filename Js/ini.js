...
(function(){
    ...
    let reproductor = document.createElement("video");
    reproductor.id = 'mi_reproductor';
    reproductor.controls = true;
    reproductor.preload = "auto";
    reproductor.style = "width:90%; margin:5px; border-radius:4px;";
    ...
    function ejecutar() {
        ...
        let url = document.getElementById("tv").value;
        if(url){
            document.getElementById("mi_reproductor").src = url;
            document.getElementById("mi_reproductor").play().catch(e => alert("Dale primero a algún botón (seguridad del navegador)"));
        }
